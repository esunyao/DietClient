...
describe('getHealthRecordDeleteSummary', () => {
  it.each([
    [
      'measurement',
      { measuredAt: '2026-08-12T08:00:00Z', weightKg: 62.3, bodyFatPercentage: null },
      '身体测量',
      '2026-08-12 · 62.3 kg',
    ],
    [
      'goal',
      { goalType: 'weight_loss', targetWeightKg: 60, targetBodyFatPercentage: null },
      '健康目标',
      '减重 · 60 kg',
    ],
    ...
    [
      'restriction',
      { restrictionName: '不吃牛肉', category: 'preference' },
      '饮食限制',
      '不吃牛肉 · 个人偏好',
    ],
