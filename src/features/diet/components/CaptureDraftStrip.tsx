...
const styles = StyleSheet.create({
  ...
  newCard: { width: 130, height: 108, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(0,113,227,0.28)', backgroundColor: '#F1F8FE', alignItems: 'center', justifyContent: 'center', gap: 5 },
