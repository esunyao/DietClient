...
export interface Meal { mealId: MealId; captureSessionId: CaptureSessionId; mealType: MealType; consumedAt: string; timezone: string; localDate: string; notes: string | null; items: MealItem[]; nutrients: NutrientValue[]; createdAt: string; updatedAt: string; }
export interface MealHistoryItem { mealId: MealId; mealType: MealType; consumedAt: string; localDate: string; notes: string | null; nutrients: NutrientValue[]; }
export interface MealPage { items: MealHistoryItem[]; page: { page: number; pageSize: number; total: number }; }
